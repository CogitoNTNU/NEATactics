...
class Config:
    ...
    new_node_small_big_chance: float = 0.03 # for big populations
    ...
    remove_worst_percentage: float = 0.8 # percentage of the worst genomes are removed from the population when breeding
